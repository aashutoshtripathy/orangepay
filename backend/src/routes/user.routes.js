...
import {processPayment, getPayment , getAllSbdata , insertBillDetails , getPayments , getDailyBalance , repostingBill , getPaymentss , fetchReward , BiharService , getTotalBalance, WalletReport, getTotalPayments, TopupReport, getTotalPaymentss} from "../controller/payment.controller.js"
import { initiateEzetapPayment , createEzetapOrder } from "../controller/ezetap.controller.js";
...
router.route("/getTotalPaymentss").get(getTotalPaymentss)
...
router.route("/createOrder").post(createEzetapOrder)
