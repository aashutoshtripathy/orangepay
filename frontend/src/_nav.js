...
export const distributorNavItems = (permissions ,dbMode, userId) =>  [
  ...
  },
  {
    ...
    items: [
      ...
      { component: CNavItem, name: 'Get Prepaid Balance', to: '/prepaid-balance-services' ,   hidden: !permissions.getPrepaidBalance, },
...
export const adminsNavItems = (permissions , userId) =>  [
  // Distributor-specific navigation items
  {
    component: CNavItem,  
    name: 'OrangePay',
...
export const distributorsNavItems = (permissions , userId) =>  [
  // Distributor-specific navigation items
  {
    component: CNavItem,
    name: 'OrangePay',
