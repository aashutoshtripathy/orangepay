...
const handleFetchBill = async () => {
  ...
  try {
    ...
    const response = await axios.post(`/api/v1/hargharbijlee/WebServiceExternal/WebServiceOPSM.asmx?op=GetConsumerBalanceDetails`, soapXml, {
      // const response = await axios.post(`/hargharbijlee/WebServiceExternal/WebServiceOPSM.asmx`, soapXml, {
      headers: {
    ...
    console.log("resultJsonString:", resultJsonString);  // Log this before parsing
